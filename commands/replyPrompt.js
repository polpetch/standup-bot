import { findById, find } from "../models/standup.model";


export const name = "reply";
export const usage = "@<optional_serverId> [ข้อความของคุณที่นี่]";
export const description = "ตอบกลับคำถามจากสแตนด์อัป";
